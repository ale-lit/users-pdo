                        ...
                        if (!empty($allUsers)) {
                            foreach ($allUsers as $user) {
                                ...
                                $result .= "<td><button type='submit' title='Редактировать' class='btn btn-warning'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-fill' viewBox='0 0 16 16'>
                                            ...
                                            <button type='button' title='Удалить' class='btn btn-danger'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash3-fill' viewBox='0 0 16 16'>
